...
{
    public partial class tbProcesosVentas
    {
        public tbProcesosVentas()
        {
            tbImagenesPorProcesosVentas = new HashSet<tbImagenesPorProcesosVentas>();
        }
        ...
        public virtual tbAgentesBienesRaices agen { get; set; }
        public virtual tbClientes clie { get; set; }
        public virtual tbMantenimientos mant { get; set; }
        public virtual tbUsuarios usua_CreacionNavigation { get; set; }
        public virtual tbUsuarios usua_ModificacionNavigation { get; set; }
        public virtual ICollection<tbImagenesPorProcesosVentas> tbImagenesPorProcesosVentas { get; set; }
    }
}